...
for s1=species1_index
    ...
    for s2=species2_index
        ...
        species2_inspecies_index=[];
        if (strcmp(parameter, 'n') || strcmp(parameter, 'k')) && numel(model.tables(s1).inspecies)>0
            species1_inspecies = model.tables(s1).inspecies;
            for i=1:numel(species2_index)
                species2_inspecies_index = [species2_inspecies_index find(species1_inspecies == species2_index(i))];
            end
        end
