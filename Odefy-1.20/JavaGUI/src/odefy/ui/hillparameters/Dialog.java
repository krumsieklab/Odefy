...
public class Dialog extends JDialog implements ActionListener, ChangeListener {
	 ...
	 */
	public Dialog(Frame parent, Double tau, Double n, Double k,
...
//		this.addSpecificPanel();
		...
		btnCancel.addActionListener(disposer);
		btnOK.addActionListener(disposer);
